...
@testset "parse line" begin
    ...
    # texts
    @test parse_command("""b-textToInterval "[1.e-3, 1.1e-3]" = [0X4.189374BC6A7ECP-12, 0X4.816F0068DB8BCP-12];""") == "@test I\"[1.e-3, 1.1e-3]\" == Interval(0x4.189374BC6A7ECP-12, 0x4.816F0068DB8BCP-12)"
    @test parse_command("""d-textToInterval "[entire]" = [-infinity, +infinity]_dac;""") == "@test @decorated(\"[entire]\") == DecoratedInterval(Interval(-Inf, +Inf), dac)"
